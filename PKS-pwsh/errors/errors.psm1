...
"
                ...
                This indicates PKS not running correctly or Awaiting Decryption Passphrase"
                }                
                "*503*" {
                    Write-Host -ForegroundColor Magenta $ExceptionMessage
                ...
                "*SSL/TLS*" {
                    Write-Host -ForegroundColor White "You are using an untrusted Connection (i.E. Selfsigned Certificates) to PKS
Please connect using 'Connect-PKSapiEndpoint -PKS_API_URI [uri] -trustCert' "
                }   
                default {
